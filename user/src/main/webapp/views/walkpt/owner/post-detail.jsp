                        ...
                        <div class="row">
                                    ...
                                    <div class="pet-card-header">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <span
                                                    class="walkpt-badge ${post.status == 'RECRUITING' ? 'badge-recruiting' : 'badge-completed'} mt-2">
                                                ...
                                                <div class="col-md-8">
                                                    <table class="table table-borderless">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <c:out value="${post.petName}" default="-" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <c:out value="${post.petWeight}" default="0" /> kg
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th><i class="fas fa-birthday-cake"></i> 나이</th>
                                                            <td>
                                                                <c:out value="${post.petAge}" default="0" />살
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <table class="table table-borderless mt-3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <c:out value="${post.walkDate}" default="-" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><i class="fas fa-clock"></i> 시간</th>
                                                    <td>
                                                        <c:out value="${post.walkTime}" default="-" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><i class="fas fa-map-marker-alt"></i> 지역</th>
                                                    <td>
                                                        <c:out value="${post.location}" default="-" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th><i class="fas fa-won-sign"></i> 보수</th>
                                                    <td><strong class="text-primary">시급
                                                            <c:choose>
                                                                <c:when test="${not empty post.payAmount}">
                                                                    <fmt:formatNumber value="${post.payAmount}"
                                                                        type="number" />원
                                                                </c:when>
                                                                <c:otherwise>
                                                                    협의
                            ...
                            <div class="col-lg-4">
                                <div class="pet-card sticky-top" style="top: 20px;">
                                    ...
                                    <div class="pet-card-body">
                                        <p><i class="fas fa-calendar-plus"></i> 작성일:
                                            <c:out value="${post.createdAt}" />
                                        </p>
                                        <p><i class="fas fa-eye"></i> 조회수:
                                            <c:out value="${post.viewCount}" />회
                                        </p>
                                        <hr>
            ...
            <script>
                ...
                function deletePost() {
                    showConfirmModal('게시글 삭제', '정말 이 게시글을 삭제하시겠습니까?', function () {
                        // TODO: 서버에 삭제 요청 (AJAX or Form submit)
